class FeedPhotos{
    constructor(){
        ...
        this.savePhotos = jQuery('#save-photos')
        ...
        this.savePhotos.on('click', async (e) => {
            e.preventDefault()
            let obj = this.getArrayObjImg()
            ...
            if(Array.isArray(obj) && obj.length <= 10){
                ...
                try{
                    resp = await jQuery.ajax({
                        ...
                        url: ajaxurl,
                        data:{
                            action: 'update_photos_feed',
                            obj: this.getArrayObjImg(),
                            postId: id
                        }
                    })
                    resp = resp.msg
                ...
                console.log('Vocẽ só pode selecionar no máximo 10 fotos') 
            }
